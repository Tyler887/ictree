...
Note that you must have `xsel` or `wl-copy` installed (depending on whether you use X11 or Wayland) to use the command.
...
## License
    ictree - Like tree utility but interactive
